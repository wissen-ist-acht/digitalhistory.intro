...
``` bash
(base) serina00@dg-19-mac-02 ~ % cd Documents/letters
```
``` bash
(base) serina00@dg-19-mac-02 letters % rm letter1.txt
```
...
And if you want to search more than one file, perhaps to find out how often the salutation “Mit herzlichem Gruß” appears in a letter collection, you have to repeat the search in every file. 
...
But it starts getting less and less neat and for the analysis of structural and textual data you can use programming languages like R or Python (as mentioned in  [@sec-digitaletools] which are more practical.
