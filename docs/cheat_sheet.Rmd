...
Every programme has its own specifications as well as useful shortcuts; over time, you will become an advanced user of certain tools you use quite often. For others, it might be handy to have a cheat sheet on the side, to remember some of the basic functions as well as different possibilities to work in an environment. This cheat sheet is very far from complete and will have the greatest benefit if you edit it according to your own needs, be it now or at any later point in time. It might also just motivate you to create a version for yourself.
...
| search for a pattern, count occurrences and write them into a new file                                                                       | `grep`                | `grep -E -o '(Arthur Dent|Arthur|Dent)'` `hitchhikers_guide_fulltext.txt |` `wc -l > arthur.txt` |
...
|------------------------|----------------|----------------|----------------|
| any single character                          | `.`              | `m.n`         | man, men                            |
| a single character out of a set of characters | `[]`             | `m[abcde]n`   | man, men                            |
| group characters/patterns                     | `[]`, `()`, `{}` | `[a-zA-Z]`    | a character in the range a-z or A-Z |
