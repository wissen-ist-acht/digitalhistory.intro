...
Für solche Vorgänge reicht ein kurzes (aber nicht unbedingt schnell erstelltes ...) [Skript](https://github.com/wissen-ist-acht/digitalhistory.intro/blob/4ebb709a0ec5bf00082d21b933d2b6c19b589f6d/docs/parse_tei_files.R), an das sich, je nach Ziel bzw. gewünschter Visualisierung, noch weitere Schritte zur Datenverfeinerung bzw. -anreicherung anschließen lassen.[^1]
...
[^1]: In diesem Fall wurde die mithilfe des verlinkten Skripts (in der Programmiersprache R) erstellte [csv-Datei](https://github.com/wissen-ist-acht/digitalhistory.intro/blob/4ebb709a0ec5bf00082d21b933d2b6c19b589f6d/docs/place_names_letters.csv) mit OpenRefine [weiter bearbeitet](https://openrefine.org/docs/manual/reconciling#reconciliation-actions), um den Adressen Geokoordinaten hinzuzufügen.
Die so [angereicherte Tabelle](https://github.com/wissen-ist-acht/digitalhistory.intro/blob/76e4fb773da1fd78949e25a023bcdc034bc7b94d/docs/place_names_letters_coordinates.csv) wurde in das Onlinetool [Palladio](https://hdlab.stanford.edu/palladio/) geladen, das Koordinaten auf einer Karte darstellen kann.
