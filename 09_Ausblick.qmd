...
[^1]: In diesem Fall wurde die mithilfe des verlinkten Skripts (in der Programmiersprache R) erstellte csv-Datei [mit OpenRefine weiter bearbeitet](https://openrefine.org/docs/manual/reconciling#reconciliation-actions), um den Adressen Geokoordinaten hinzuzufügen.
Die so angereicherte Tabelle wurde in das Onlinetool [Palladio](https://hdlab.stanford.edu/palladio/) geladen, das Koordinaten auf einer Karte darstellen kann.
