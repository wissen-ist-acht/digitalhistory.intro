...
Eine Dokumentation und die Sicherung in einem Repositorium, einem Langzeitspeicher für Daten, sorgt zusätzlich für Sichtbarkeit und die Möglichkeit zur Nachnutzung von Ergebnissen. Als Fachrepositorien für die Geschichtswissenschaften existieren beispielsweise [AMAD](https://www.amad.org/) (Mittelalter), oder ganz generell [Zenodo](https://zenodo.org/) (fächerübergreifend, betrieben durch das CERN) -- Sie können Ihre Forschungsdaten dort  kostenfrei ablegen, Ihre Urheberschaft nachweisen und die Daten/Publikation mit einem DOI (Digital Object Identifier) zitierbar machen.
